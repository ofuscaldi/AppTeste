...
class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    let urlPost = URLsController.URLs.postlogin
    ...
    @IBAction func btnLogin(_ sender: UIButton) {
        ...
        Alamofire.request(urlPost, method: .post, parameters: ["email": emailTextField.text!, "senha": senhaTextField.text!], encoding: URLEncoding.default, headers: nil).validate().responseJSON() { response in
